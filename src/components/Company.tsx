...
const values = [
  {
    icon: Sparkles,
    title: "Innovation",
    desc: "Toujours à la pointe des technologies modernes.",
  },
  {
    icon: Zap,
    title: "Performance",
    desc: "Des architectures rapides, optimisées et scalables.",
  },
  {
    icon: Code2,
    title: "Design premium",
    desc: "Des interfaces immersives, fluides et inoubliables.",
  },
  {
    icon: Cpu,
    title: "Solutions sur mesure",
    desc: "Un code robuste, adapté à vos règles métiers.",
  },
];
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 relative z-10">
        ...
        <div className="flex-1 company-content">
          ...
          <p className="text-lg md:text-xl text-white/50 leading-relaxed max-w-2xl mb-12 font-light">
            Nous sommes un studio digital spécialisé dans la création de
            solutions web et mobiles sur mesure. Nous accompagnons les PME et
            les entreprises en croissance dans leur transformation numérique en
            combinant ingénierie de pointe et design cinématique.
          </p>
