...
-- CreateEnum
CREATE TYPE "QuoteItemType" AS ENUM ('ACCOMMODATION', 'EXCURSION', 'TRANSPORT', 'ADDITIONAL_SERVICE');
...
-- CreateEnum
CREATE TYPE "ServiceUnit" AS ENUM ('PERSON', 'DAY', 'FLAT');
...
CREATE TABLE "additional_services" (
    ...
    "description" TEXT,
    "price" INTEGER NOT NULL,
    "unit" "ServiceUnit" NOT NULL DEFAULT 'PERSON',
    "icon" TEXT,
    "isFeatured" BOOLEAN NOT NULL DEFAULT false,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "quote_items" ADD CONSTRAINT "quote_items_additionalServiceId_fkey" FOREIGN KEY ("additionalServiceId") REFERENCES "additional_services"("id") ON DELETE SET NULL ON UPDATE CASCADE;
